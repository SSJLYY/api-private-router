  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div v-if="showOAuthLogin" class="space-y-3 pt-1">
        ...
        <CommunityOAuthSection
          v-if="communityOAuthEnabled"
          :disabled="isLoading"
          :aff-code="formData.aff_code"
          :show-divider="false"
        />
...
import CommunityOAuthSection from '@/components/auth/CommunityOAuthSection.vue'
...
const communityOAuthEnabled = ref<boolean>(false)
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || 'api-private-router'
    communityOAuthEnabled.value = settings.linuxdo_oauth_enabled
