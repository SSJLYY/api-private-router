  ...
  <AppLayout>
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <!-- Tab: Security — Registration, Turnstile, Community -->
        <div v-show="activeTab === 'security'" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <code
                        v-if="communityRedirectUrlSuggestion"
                        class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                      >
                        {{ communityRedirectUrlSuggestion }}
                      </code>
                    </div>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
        ...
        <!-- /Tab: Security — Registration, Turnstile, Community, OIDC -->
        ...
        <div v-show="activeTab === 'payment'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              ...
              <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                {{ t("admin.settings.payment.configGuideHint") }}
              </p>
            </div>
            <div class="space-y-4 p-6">
              <!-- Enable toggle -->
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "api-private-router") +
                        " 100 " +
...
const form = reactive<SettingsForm>({
  ...
  site_logo: "",
  site_subtitle: "Unified AI access for your team",
  api_base_url: "",
  contact_info: "",
  doc_url: "",
  home_content: "",
...
// Community OAuth redirect URL suggestion
const communityRedirectUrlSuggestion = computed(() => {
  if (typeof window === "undefined") return "";
  const origin =
    window.location.origin ||
    `${window.location.protocol}//${window.location.host}`;
  return `${origin}/api/v1/auth/oauth/community/callback`;
});

async function setAndCopyLinuxdoRedirectUrl() {
  const url = communityRedirectUrlSuggestion.value;
  if (!url) return;
