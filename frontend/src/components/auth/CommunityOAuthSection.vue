  ...
  <div class="space-y-4">
    <button type="button" :disabled="disabled" class="btn btn-secondary w-full" @click="startLogin">
      <svg
        ...
        aria-hidden="true"
      >
        <g id="community_icon" data-name="community_icon">
          <path
...
import { getCommunityOAuthStartPath } from '@/api/auth'
...
function startLogin(): void {
  ...
  const startURL = `${normalized}${getCommunityOAuthStartPath()}?redirect=${encodeURIComponent(redirectTo)}`
