export default {
  ...
  setup: {
    title: 'Project Setup',
    description: 'Configure your project instance',
    database: {
  ...
  auth: {
    ...
    linuxdo: {
      signIn: 'Continue with Community',
      ...
      invitationRequired: 'This Community account is not yet registered. The site requires an invitation code — please enter one to complete registration.',
      invalidPendingToken: 'The registration token has expired. Please sign in with Community again.',
    ...
    linuxdoCallbackPageTitle: 'Community Sign-In Callback',
    communityCallbackPageTitle: 'Community Sign-In Callback',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. api-private-router-backups), choose a region',
    ...
    accounts: {
      ...
      syncFromCrs: 'Sync from Remote Source',
      dataExport: 'Export',
      ...
      syncFromCrsTitle: 'Sync Accounts from Remote Source',
      syncFromCrsDesc:
        'Sync accounts from a remote source into this system through a server-to-server connection.',
      crsVersionRequirement: 'Note: the remote source must support export sync for this feature to work.',
      crsBaseUrl: 'Remote Source URL',
      ...
      crsNoNewAccounts: 'All remote-source accounts are already synced.',
      crsWillUpdate: 'Will update {count} existing accounts.',
      crsSelectedCount: '{count} new accounts selected',
      crsUpdateBehaviorNote:
        'Existing accounts only sync fields returned by the remote source; missing fields keep their current values. Credentials are merged by key, and proxies are preserved when "Sync proxies" is unchecked.',
      crsBack: 'Back',
      syncFromRemoteSourceTitle: 'Sync Accounts from Remote Source',
      syncFromRemoteSourceDesc: 'Sync accounts from a remote source into this system through a server-to-server connection.',
      remoteSourceVersionRequirement: 'Note: the remote source must support export sync for this feature to work.',
      externalSourceBaseUrl: 'Remote Source URL',
      externalSourceBaseUrlPlaceholder: 'e.g. http://127.0.0.1:3000',
      externalSourceUsername: 'Username',
      externalSourcePassword: 'Password',
      remoteSourcePreview: 'Preview',
      remoteSourcePreviewing: 'Previewing...',
      remoteSourcePreviewFailed: 'Preview failed',
      remoteSourceExistingAccounts: 'Existing accounts (will be updated)',
      remoteSourceNewAccounts: 'New accounts (select to sync)',
      remoteSourceSelectAll: 'Select all',
      remoteSourceSelectNone: 'Select none',
      remoteSourceNoNewAccounts: 'All remote-source accounts are already synced.',
      remoteSourceWillUpdate: 'Will update {count} existing accounts.',
      remoteSourceSelectedCount: '{count} new accounts selected',
      remoteSourceUpdateBehaviorNote:
        'Existing accounts only sync fields returned by the remote source; missing fields keep their current values. Credentials are merged by key, and proxies are preserved when "Sync proxies" is unchecked.',
      remoteSourceBack: 'Back',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable when the upstream points to another compatible relay instance.',
    ...
    ops: {
      ...
      tooltips: {
        ...
        threads:
          'Number of JVM/runtime threads. There is no absolute "safe" number; use your historical baseline. Heuristic: <2k is common; 2k-8k watch; >8k plus rising queue/latency often suggests blocking/leaks.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure Community OAuth for end-user sign-in',
        enable: 'Enable Community Login',
        enableHint: 'Show Community login on the login/register pages',
        clientId: 'Client ID',
        clientIdPlaceholder: 'e.g., hprJ5pC3...',
        clientIdHint: 'Get this from your Community OAuth provider',
        ...
        redirectUrlPlaceholder: 'https://your-domain.com/api/v1/auth/oauth/community/callback',
        redirectUrlHint:
          'Must match the redirect URL configured in your Community OAuth provider (must be an absolute http(s) URL)',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'api-private-router',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'Unified AI access for your team',
      ...
      payment: {
        ...
        configGuideHint: 'Provider setup, callback paths, payment routing, and instance management are documented in the deployment bundle. Verify them against your current environment.',
        ...
        findProvider: 'For EasyPay integrations, choose providers with clear settlement rules, stable callbacks, and predictable operations.',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'api-private-router',
        useTls: 'Use TLS',
      ...
      authSourceDefaults: {
        ...
        requireEmailHint: 'When enabled, Community, OIDC, and WeChat signups must provide an email before account creation.',
        ...
        sources: {
          ...
          linuxdo: {
            ...
            description: 'Default quota grants for Community signups.'
          },
          oidc: {
            title: 'OIDC signup',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to api-private-router',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">api-private-router is a flexible AI access platform for managing access, routing, and usage.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers and access scopes</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core way to organize access and pricing in this project, similar to a service package:</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has an independent billing multiplier</li><li>👥 Groups can be public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "Priority" and "Trial" groups with different rules</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to api-private-router',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to api-private-router.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create an API key</li><li>📋 Copy the key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
