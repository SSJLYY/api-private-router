/** WebSearch emulation mode values shared with the backend account settings. */
...
/** Quota notification threshold type values shared with backend balance notification settings. */
