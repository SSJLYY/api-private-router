 ...
 *   ["api-private-router-admin", "jwt.<token>"]
 */
...
const OPS_WS_BASE_PROTOCOL = 'api-private-router-admin'
...
export function subscribeQPS(onMessage: (data: any) => void, options: SubscribeQPSOptions = {}): () => void {
  ...
  const connect = () => {
    ...
    // Sec-WebSocket-Protocol (subprotocol list): ["api-private-router-admin", "jwt.<token>"].
